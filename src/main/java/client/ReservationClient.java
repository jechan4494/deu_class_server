...
public class ReservationClient {
    ...
    public List<User> getAllUsers() {
        try {
            System.out.println("모든 사용자 정보 조회 시도");
            List<User> users = reservationService.getAllUsers();
            System.out.println("사용자 정보 조회 성공: " + users.size() + "명의 사용자");
            return users;
        } catch (Exception e) {
    ...
    public boolean registerUser(User user) {
        try {
            System.out.println("사용자 등록 시도: " + user.getName() + "님");
    ...
    public boolean makeReservation(Reservation reservation) {
        try {
            System.out.println("예약 시도: " + reservation.getName() + "님의 " + 
    ...
    public List<Reservation> getUserReservations(String name, String role) {
        try {
            System.out.println("예약 조회 시도: " + name + "님의 예약 목록");
    ...
    public boolean cancelReservation(Reservation reservation) {
        try {
            System.out.println("예약 취소 시도: " + reservation.getName() + "님의 " + 
                reservation.getRoomType() + " " + reservation.getRoomNumber() + "호 예약");
    ...
    public List<Reservation> getAllReservations() {
        try {
            System.out.println("전체 예약 목록 조회 시도");
    ...
    public boolean updateReservationState(Reservation reservation, String newState) {
        try {
            System.out.println("예약 상태 업데이트 시도: " + reservation.getName() + "님의 예약을 " + 
                newState + " 상태로 변경");
    ...
    public boolean isRoomAvailable(int roomNumber, String day, List<String> timeSlots, String roomType) {
        try {
            System.out.println("강의실 가용성 확인: " + roomType + " " + roomNumber + "호 " + 
